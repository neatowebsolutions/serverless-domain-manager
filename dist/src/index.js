...
class ServerlessCustomDomain {
    ...
    getCertArn(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const certificates = yield (0, utils_1.getAWSPagedResults)(domain.acm, "listCertificates", "CertificateSummaryList", "NextToken", "NextToken", { CertificateStatuses: certStatuses });
    ...
    changeResourceRecordSet(action, domain) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const latencyRecordConfig = domain.route53Params.routingPolicy === "latency"
                ? Object.assign({ Region: domain.region, SetIdentifier: (_a = domain.route53Params.setIdentifier) !== null && _a !== void 0 ? _a : domain.domainInfo.domainName }, healthCheckConfig) : {};
            const weightedRecordConfig = domain.route53Params.routingPolicy === "weighted"
                ? Object.assign({ Weight: domain.route53Params.weight, SetIdentifier: (_b = domain.route53Params.setIdentifier) !== null && _b !== void 0 ? _b : domain.domainInfo.domainName }, healthCheckConfig) : {};
            const Changes = ["A", "AAAA"].map((Type) => ({
                Action: action,
                ResourceRecordSet: Object.assign(Object.assign({ AliasTarget: {
                        DNSName: domain.domainInfo.domainName,
                        EvaluateTargetHealth: false,
                        HostedZoneId: domain.domainInfo.hostedZoneId,
                    }, Name: domain.givenDomainName, Type }, latencyRecordConfig), weightedRecordConfig),
            }));
            const params = {
                ChangeBatch: {
                    Changes,
    ...
    getRoute53HostedZoneId(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                hostedZoneData = yield (0, utils_1.throttledCall)(this.route53, "listHostedZones", {});
